...
var x = bmiMark = massMark / (heightMark * heightMark);
console.log(x);

var y = bmiJohn = massJohn / (heightJohn * heightJohn);
console.log(y);

var z = bmiMark > bmiJohn;
console.log(z);

console.log("Is Mark's BMI higher than John's ? " + z);
...
log the average winner to the console. HINT: you will need the && operator to take the decision. If
 ...
 */
 ...
 /**
  ...
  To tip the waiter a fair amount, John created a simple tip calcualtor (as a function). He likes
 ...
 */
 ...
 2. Then , add a method to each object to calculate the BMI. Save the BMI to the object and also return it from 
 the method.
 3.In the end, log to the console who has the highest BMI, together with the full name and the respective BMI. Don't 
...
//  i = 1 , 1 < 10 true, log i to conosle, i++
// ...
//  i = 9 , 9 < 10 true, log i to conosle, i++
 ...
 */
 ...
 This time, John and his family went to 5 different restaurants. The bills were $!24, $48, $268, $180 and $42.
 John likes to tip 20% of the bill when the bil is less than $50, 15% when the bill is between $50 and $200, and 10%
 ...
 4.As an output, create 1) a new array containing all tips, and 2) an array containing final paid amaounts(bill + tip). 
 ...
 sum in variable (starting from 0). After you have the sum of the array, divide it by the number of elemnents in it(that's how you calculate the average)
